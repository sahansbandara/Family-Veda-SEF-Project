...
export function CasesPage() {
  ...
  return <div className="page-stack">
    <header className="page-header"><div><p className="eyebrow">Verified doctor portal</p><h1>Triage cases</h1><p>Granted cases and emergency referrals released to verified doctors appear here.</p></div><StatusBadge status="VERIFIED" /></header>
